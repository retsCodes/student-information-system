  ...
  Widget _buildSummaryCards() {
    return GridView.count(
      ...
      children: [
        ...
        _buildSummaryCard(
          'In Progress',
          '${_progress!.inProgressCount}',
          Icons.hourglass_empty,
          Colors.orange,
        ),
        _buildSummaryCard(
          'Average Grade',
          _progress!.averageGrade != null
              ? _progress!.averageGrade!.toStringAsFixed(2)
              : '—',
          Icons.grade,
          Colors.purple,
        ),
          ...
          child: Column(
            children: [
              ...
              ListTile(
                onTap: () {
                  setState(() {
                    _expandedYear = isExpanded ? -1 : year.year;
                  });
                },
                ...
                Padding(
                  ...
                  child: Column(
                    children: year.semesters.map((semester) {
                      return _buildSemesterSection(semester);
                    }).toList(),
                  ),
                ),
            ],
