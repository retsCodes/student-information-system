...
class _DashboardScreenState extends State<DashboardScreen> {
      ...
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Row(
            ...
            children: [
              const AppLogo(height: 32, width: 32),
  ...
  // Helper method to shorten long names
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            if (_dashboardData!.paymentStats.unpaidCount > 0)
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              _buildInfoChip(
                Icons.book,
                user.program != null && user.program!.length > 20
                    ? '${user.program!.substring(0, 17)}...'
                    : user.program ?? 'No Program',
              ),
              _buildInfoChip(
                Icons.grade,
                user.yearLevel != null ? 'Year ${user.yearLevel}' : 'Year Not Set',
              ),
              _buildInfoChip(
                Icons.check_circle,
                user.enrollmentStatus.toUpperCase(),
                color: Colors.green,
              ),
            ],
          ),
  ...
  Widget _buildStatisticsGrid() {
    ...
    return GridView.count(
      ...
      children: [
        ...
        _buildStatCard(
          'Total Due',
          '₱${stats.totalDue.toStringAsFixed(2)}',
          Icons.money_off,
          Colors.red,
        ),
        _buildStatCard(
                ...
                _buildActionButton(
                  ...
                  Colors.orange,
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Visit registrar\'s office for assistance'),
